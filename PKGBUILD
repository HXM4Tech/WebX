...
install="package_archlinux/install.sh"
backup=("etc/webx/config.toml" "usr/lib/systemd/system/webx@.service")
...
package() {
    ...
    install -Dm755 "py-src/cli.py" "$pkgdir/usr/bin/webx-cli"
